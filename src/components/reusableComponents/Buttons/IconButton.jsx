...
export const IconButton = ({disabled, $iconType, $type, id, $position, $top, $right, $size, onClick, children}) => {
    return (
        <IconBtn disabled={disabled} id={id} type={$type} $position={$position} $top={$top} $right={$right} onClick={onClick} >
